...
import 'schema/item_catalog_record.dart';
import 'schema/trips_record.dart';
import 'schema/shipments_record.dart';
import 'schema/shipment_transfers_record.dart';
...
export 'schema/item_catalog_record.dart';
export 'schema/trips_record.dart';
export 'schema/shipments_record.dart';
export 'schema/shipment_transfers_record.dart';
...
/// Functions to query ItemCatalogRecords (as a Stream and as a Future).
Future<int> queryItemCatalogRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ItemCatalogRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ItemCatalogRecord>> queryItemCatalogRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ItemCatalogRecord.collection,
      ItemCatalogRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ItemCatalogRecord>> queryItemCatalogRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ShipmentTransfersRecords (as a Stream and as a Future).
Future<int> queryShipmentTransfersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ShipmentTransfersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ShipmentTransfersRecord>> queryShipmentTransfersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ShipmentTransfersRecord.collection,
      ShipmentTransfersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ShipmentTransfersRecord>> queryShipmentTransfersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
